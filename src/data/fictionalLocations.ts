import {
	...
	streelingUniversity,
	trantorUniversity,
	type FictionalUniversity,
} from './fictionalUniversities';
...
export interface FictionalLocation {
	...
	topics: string[];
	storeLink: string;
	universities: FictionalUniversity[];
}

export const fictionalLocations: FictionalLocation[] = [
	{
...
export const locationUniversityRoutes = fictionalLocations.flatMap((location) =>
