...
export interface MultiverseUniversity {
	id: string;
	name: string;
	shortName: string;
	universe: string;
...
export const miskatonicUniversity: MultiverseUniversity = {
	id: "miskatonic",
...
export const streelingUniversity: MultiverseUniversity = {
	id: "streeling",
...
export const trantorUniversity: MultiverseUniversity = {
	id: "trantor",
...
export const arrakisUniversity: MultiverseUniversity = {
	id: "arrakis",
...
export const baSingSeUniversity: MultiverseUniversity = {
	id: "ba-sing-se",
